    ...
    <div class="space-y-4">
      <div>
        ...
        <Input
          id="count"
          type="number"
          class="w-full px-3 py-2 text-center text-lg font-mono"
          v-model="count"
        />
      </div>

      <div class="flex gap-3">
        <Button @click="increment" class="flex-1"> Increment </Button>
        <Button variant="secondary" @click="reset" class="flex-1"> Reset </Button>
      </div>
    </div>
  </div>
</template>
